...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Deploy By', url='https://t.me/file_sharing_support'),
